...
import { getTop10UsedWords } from "../../actions/occurenceJanvier.actions";
...
const WordCloudJanvier = () => {
  ...
  return (
    <>
      <div>
        <h3 className="text-center">Les 10 tendances recurrentes de Janvier 2023</h3>
      </div>
      <div>
...
export default WordCloudJanvier;
