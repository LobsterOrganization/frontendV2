...
import { getTop10UsedWords } from "../../actions/occurenceMars.actions";
...
const WordCloudMars = () => {
  ...
  return (
    <>
      <div>
        <h3 className="text-center">Les 10 tendances recurrentes de Mars 2023</h3>
      </div>
      <div>
